...
function App() {
  ...
  let config = {
    contract: {
        address: "0xe8a7a43e350763010f521798a41cb9c8bbb31395",
        abi: [
          {
            "inputs": [
              {
    ...
    apiKey: {
        test: "59fRCMXvk.8a1652f0-b522-4ea7-b296-98628499aee3"
  ...
  async function sendGaslessTransaction() {
    ...
    let {data} = await contract.populateTransaction.mint();
    console.log(data)
      const tx1 = {
        to: "0xe8a7a43e350763010f521798a41cb9c8bbb31395",
        data: data
  ...
  const mintNftButton = () => {
    return (
      <button onClick={sendGaslessTransaction} className='cta-button mint-nft-button'>
         Mint NFT
       </button>  
    )
  }
  ...
  return (
    ...
    <>
     ...
     <div align="center">
       ...
       <div align="center">
       <a href="http://localhost:3000"><div>Continue</div></a>
       </div>
